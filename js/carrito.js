...
const renderizarCarrito = () => {
    ...
    contenedor.innerHTML = ""; // al disparar la funcion renderizarCarrito, borra lo viejo y renderiza lo nuevo
    divAcciones.innerHTML = ""; // sino se resetea con el divacciones, no se actualiza el carrito
...
//Invocar activacion de la funcion (una vez cargado el HTML)
